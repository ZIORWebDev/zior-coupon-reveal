...
class CouponsCategoriesList extends AbstractBlock {

	protected $block_name = 'coupons-categories-list';
			...
			$output .= '
				<li class="zior-block-coupon-taxonomies-list-item">
					<a style="' . esc_attr( $link_color_style ) . '" href="' . esc_attr( get_term_link( $category->term_id, 'coupon-categories' ) ) . '">'
						...
						. '<span class="zior-block-coupon-taxonomies-list-item__name">' . esc_html( $category->name ) . '</span>'
					. '</a>'
