...
class ZIOR_Blocks_Loader {
	...
	public function enqueue_scripts() {
		wp_enqueue_style( 'zr-blocks', ZR_COUPON_PLUGIN_URL . 'build/zr-blocks.min.css', array(), ZR_COUPON_VERSION );
		wp_enqueue_script( 'zr-blocks', ZR_COUPON_PLUGIN_URL . 'build/zr-blocks.min.js', [
			'wp-blocks',
			'wp-i18n',
			'wp-element',
			'wp-components',
