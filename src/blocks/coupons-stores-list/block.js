...
const EmptyPlaceholder = () => (
	...
	>
		{ __(
			"This block displays the coupon stores for your store. To use it you first need to create a coupon and assign it to a store.",
			"zior-couponreveal"
		) }
	</Placeholder>
);
...
const CouponCategoriesBlock = ( { attributes, setAttributes, name } ) => {
	const getInspectorControls = () => {
		const { hasCount, hasImage, isHierarchical, hasTitle, featuredOnly } =
			attributes;
